...
print('a =', a, 'AU,', 'JPL value:', a_jpl, 'percent error:', str(odlib.get_percent_error(a_jpl, a)) + '%')
print('e =', e, 'JPL value:', e_jpl, 'percent error:', str(odlib.get_percent_error(e_jpl, e)) + '%')
print('i =', math.degrees(i), 'degrees', 'JPL value:', i_jpl, 'percent error:', str(odlib.get_percent_error(i_jpl, math.degrees(i))) + '%')
print('omega =', math.degrees(w), 'degrees', 'JPL value:', w_jpl, 'percent error:', str(odlib.get_percent_error(w_jpl, math.degrees(w))) + '%')
print('Omega =', math.degrees(o), 'degrees', 'JPL value:', o_jpl, 'percent error:', str(odlib.get_percent_error(o_jpl, math.degrees(o))) + '%')
print('M =', math.degrees(MA_central), 'degrees at central obs. (JD =', str(time[1]) + ')', 'JPL value:', MA_jpl, 'percent error', str(odlib.get_percent_error(MA_jpl, math.degrees(MA_central))))
...
print('M =', math.degrees(MA_future), 'degrees at JD =', str(JD_curr))
